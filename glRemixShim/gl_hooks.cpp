...
namespace glRemix::hooks
{
    ...
    {
        GLGenTexturesCommand payload{static_cast<uint32_t>(n)};
    ...
    {
        GLDeleteTexturesCommand payload{static_cast<uint32_t>(n)};
    ...
    {
        GLLightfvCommand payload{light,
                                          pname,
    ...
    {
        GLMaterialfvCommand payload{face,
                                             pname,
                                             {params[0], params[1], params[2], params[3]}};
