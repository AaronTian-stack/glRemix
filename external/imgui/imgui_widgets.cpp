...
// FIXME: This would work nicely if it was a public template, e.g. 'template<IN> RadioButton(const char* label, IN* v, IN v_button)', but I'm not sure how we would expose it..
